# Generated by Django 3.2.12 on 2022-05-13 07:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hcm.maddress')),
            ],
            options={
                'db_table': 'm_company',
                'managed': True,
        ...
        migrations.CreateModel(
            name='MEmployee',
            fields=[
                ('employee', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='hcm.account')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hcm.mcompany')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='maddress',
            name='state',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hcm.mstate'),
        ),
        migrations.CreateModel(
            name='TLeave',
            fields=[
                ...
                ('leave_type', models.CharField(choices=[('CL', 'Casual Leaves'), ('SL', 'Sick Leaves'), ('PL', 'Parental Leaves'), ('LWP', 'Leave Without Pay')], max_length=20)),
                ...
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hcm.memployee')),
            ],
            options={
                'db_table': 't_leave',
                'managed': True,
        ...
        migrations.AddField(
            ...
            name='address',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='hcm.maddress'),
        ),
        migrations.AddField(
            model_name='memployee',
            name='company',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hcm.mcompany'),
        ),
        migrations.AddField(
            model_name='memployee',
            name='department',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hcm.mdepartment'),
        ),
        migrations.AddField(
            model_name='memployee',
            name='grade',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hcm.mgrade'),
        ),
        migrations.CreateModel(
            name='MPaygrade',
            fields=[
                ...
                ('grade', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hcm.mgrade')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hcm.memployee')),
            ],
            options={
                'db_table': 'm_paygrade',
